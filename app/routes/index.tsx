...
async function getProjects(user: User) {
  const projects = await fetch(`https://app.launchdarkly.com/api/v2/projects`,{
    headers: new Headers({
        ...
        <div style={{ fontFamily: 'system-ui, sans-serif', lineHeight: '1.4' }}>
            ...
            <p>
                ...
                <label>
                    Select Project:
                    <br />
                    <select name="project-key" id="project-key-select" onChange={updateProject}>
            ...
            { selectedFlag && <FlagTemplateComponent user={user} flag={selectedFlag} projectKey={selectedProject} />}
        </div>
